...
var n011_randomUseCardByID = function(owner) {
    return nodes.randomUseCardByID(owner, [1001, 1002, 1003], [10, 20, 30]);
};
...
var bt_code = {
    ...
    // Sequence
    n0_Sequence: {type: bt_consts.NodeType.SEQUENCE, children: ['n00_isCardInHand', 'n01_isMpEnoughToUseCard', 'n02_isThewEnoughToUseCard', 'n03_selectTarget', 'n04_selectHatredTarget', 'n05_canUseCard', 'n06_showText', 'n07_checkAttributes', 'n08_useCard', 'n09_showText', 'n010_quit', 'n011_randomUseCardByID']},
